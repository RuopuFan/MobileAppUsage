...
- What are the app preferences for users using different app stores (e.g. iOS vs Android)?

- What categories are more male-/female-dominated? What are some of the gender-neutral categories? How are they connected with the user's age, occupation, nationality, and educational background?
